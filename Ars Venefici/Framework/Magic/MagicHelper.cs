...
namespace ArsVenefici.Framework.Magic
{
    public class MagicHelper : IMagicHelper
    {
        ...
        int LearnedAffinitiesEventId { get; } = 9918173;
        ...
        public int GetLearnedAffinitiesEventId()
        {
            return LearnedAffinitiesEventId;
        }
        ...
        public bool LearnedAffinities(Farmer farmer)
        {
            return Game1.player?.eventsSeen?.Contains(LearnedAffinitiesEventId.ToString()) == true ? true : false;
        }
