...
namespace ArsVenefici.Framework.Spells.Registry
{
    ...
    {
        public static MagicAltarTab utilityTab = MagicAltarTab.create(ModEntry.INSTANCE.Helper.Translation.Get("ui.magic_altar.utility_tab.name"), ModEntry.INSTANCE.Helper.ModContent.Load<Texture2D>("assets/gui/occulus/utility.png"), ModEntry.INSTANCE.Helper.ModContent.Load<Texture2D>("assets/icon/interface/utility.png"), MagicAltarTab.TEXTURE_WIDTH, MagicAltarTab.TEXTURE_HEIGHT, 400, 50, 3); //136
        public static MagicAltarTab defenseTab = MagicAltarTab.create(ModEntry.INSTANCE.Helper.Translation.Get("ui.magic_altar.defense_tab.name"), ModEntry.INSTANCE.Helper.ModContent.Load<Texture2D>("assets/gui/occulus/defense.png"), ModEntry.INSTANCE.Helper.ModContent.Load<Texture2D>("assets/icon/interface/defense.png"), MagicAltarTab.TEXTURE_WIDTH, MagicAltarTab.TEXTURE_HEIGHT, 400, 50, 2); //181
        public static MagicAltarTab offenceTab = MagicAltarTab.create(ModEntry.INSTANCE.Helper.Translation.Get("ui.magic_altar.offense_tab.name"), ModEntry.INSTANCE.Helper.ModContent.Load<Texture2D>("assets/gui/occulus/offense.png"), ModEntry.INSTANCE.Helper.ModContent.Load<Texture2D>("assets/icon/interface/offense.png"), MagicAltarTab.TEXTURE_WIDTH, MagicAltarTab.TEXTURE_HEIGHT, 200, 50, 1); //226 //46
        public static MagicAltarTab affinityTab = MagicAltarTab.create(ModEntry.INSTANCE.Helper.Translation.Get("ui.magic_altar.affinity_tab.name"), ModEntry.INSTANCE.Helper.ModContent.Load<Texture2D>("assets/gui/occulus/utility.png"), ModEntry.INSTANCE.Helper.ModContent.Load<Texture2D>("assets/icon/interface/affinity.png"), MagicAltarTab.TEXTURE_WIDTH, MagicAltarTab.TEXTURE_HEIGHT, 400, 50, 0); //136
